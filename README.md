...
怎樣動滑鼠決定掉什麼；電腦越燒，掉出的食物就越大顆：

- **碎屑**（小）— 左右甩滑鼠掉出，麻糬就地吃掉補體力
- **糖粒**（中）— 上下甩滑鼠掉出，需要一點精力；單隻扛回左下角巢穴
- **糖塊**（大）— 精力條滿時自動掉出，多隻合作推到巢穴口拋入

精力條藏在畫面右下角，敲鍵盤、點滑鼠、CPU 燒起來都會幫它漲 — 你越忙，麻糬們越開心。

麻糬累壞會趴在原地喘氣，吃幾片碎屑就能爬起來。
